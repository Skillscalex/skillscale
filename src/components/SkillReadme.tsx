    ...
    <div className="bg-[#12121a] border border-[#1e1e2e] rounded-2xl overflow-hidden">
      ...
      {!collapsed && (
        <div className="px-6 py-5 prose prose-invert prose-sm max-w-none
          ...
          [&_li]:text-[#8b8ba7] [&_li]:text-sm [&_li]:list-disc [&_li]:marker:text-[#7c3aed]
          [&_strong]:text-[#f8f8ff] [&_strong]:font-semibold
          [&_code]:text-[#a78bfa] [&_code]:bg-[#1e1e2e] [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-xs [&_code]:font-mono
          [&_pre]:bg-[#0e0e16] [&_pre]:border [&_pre]:border-[#1e1e2e] [&_pre]:rounded-xl [&_pre]:p-4 [&_pre]:overflow-x-auto [&_pre]:mb-4
          [&_pre_code]:bg-transparent [&_pre_code]:p-0 [&_pre_code]:text-[#a78bfa]
          [&_hr]:border-[#1e1e2e] [&_hr]:my-4
          [&_a]:text-[#7c3aed] [&_a]:no-underline [&_a:hover]:underline
        ">
